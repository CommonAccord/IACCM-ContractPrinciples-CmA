...
Concept.xlist=<ul class="secs-and"><li>{Concept.secs}</li></ul>
...
Principle.1.xlist=<ul class="secs-and"><li>{Principle.1.secs}</li></ul>
...
Principle.2.xlist=<ul class="secs-and"><li>{Principle.2.secs}</li></ul>
...
Principle.3.xlist=<ul class="secs-and"><li>{Principle.3.secs}</li></ul>

Principle.=[G/Z/ol-AA/3]

Principle.xlist=<ul class="secs-and"><li>{Principle.Secs}</li></ul>
