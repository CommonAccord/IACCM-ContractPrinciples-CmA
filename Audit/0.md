...
Def.sec={Def.0.sec}<ul><li>{Def.Financial_Audit.Sec}<li>{Def.Compliance_Audit.Sec}<li>{Def.Service_Quality_Audit.Sec}</ul>
...
Clause.=[G/IACCM-ContractPrinciples-CmA/Audit/Clause/0.md]
